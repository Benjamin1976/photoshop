...
exportDialog.namePanel.nameBox = exportDialog.namePanel.add(
  "edittext",
  undefined,
  "Name"
);
...
exportDialog.methodOptions = exportDialog.add("dropdownlist", undefined, [
  ResizeMethod.AUTO.name,
  ResizeMethod.NEARESTNEIGHBOUR.name,
  ResizeMethod.BILINEAR.name,
  ResizeMethod.BICUBIC.name,
  ResizeMethod.BICUBICSMOOTHER.name,
  ResizeMethod.BICUBICSHARPER.name,
]);
exportDialog.methodOptions.children[0].selected = true;

exportDialog.add("statictext", undefined, "Orignal density: ");
exportDialog.originalDensityOptions = exportDialog.add(
  "dropdownlist",
  undefined,
  [
    OriginalDensity.MDPI.name,
    OriginalDensity.HDPI.name,
    OriginalDensity.XHDPI.name,
    OriginalDensity.XXHDPI.name,
  ],
  "den"
);
exportDialog.originalDensityOptions.children[2].selected = true;

exportDialog.scaleStylesCheckBox = exportDialog.add(
  "checkbox",
  undefined,
  "Scale Styles"
);
...
exportDialog.buttonGroup.cancelButton = exportDialog.buttonGroup.add(
  "button",
  undefined,
  "Cancel"
);
exportDialog.buttonGroup.okButton = exportDialog.buttonGroup.add(
  "button",
  undefined,
  "OK"
);
